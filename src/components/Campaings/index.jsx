                      ...
                      <>
                        {
                          ((new Date().getTime() <= new Date('2025-12-10T00:00:00Z').getTime()) && i === 0) && (
                            <Link to={"https://www.youtube.com/playlist?list=PLmuix2GfdrZ471GlANYt0mx-wa5EeDAIw"} target={"_blank"} rel={"noopener noreferrer"} className={"my-3 text-decoration-none"} key={i}>
                              <div className={"text-white"}>
                                ...
                                <span className={"d-block text-balance text-white-50 lh-sm mt-3 text-decoration-underline"} style={{fontWeight: "300"}}>Disponível no Youtube</span>
                              </div>
                            </Link>
                          )
                        }
